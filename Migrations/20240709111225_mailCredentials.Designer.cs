...
namespace old_planner_api.Migrations
{
    ...
    [Migration("20240709111225_mailCredentials")]
    partial class mailCredentials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("old_planner_api.src.Domain.Models.TaskAttachedMessage", b =>
                {
                    b.Property<Guid>("TaskId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TaskAttachedMessages");
                });
            ...
            modelBuilder.Entity("old_planner_api.src.Domain.Models.UserMailCredentials", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("old_planner_api.src.Domain.Models.TaskAttachedMessage", b =>
                {
                    b.HasOne("old_planner_api.src.Domain.Models.ChatMessage", "Message")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("old_planner_api.src.Domain.Models.UserModel", b =>
                {
                    ...
                    b.Navigation("UserMailCredentials");
                });
